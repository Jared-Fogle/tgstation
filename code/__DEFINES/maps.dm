...
#define ZTRAIT_SUMMON_FROST_MOTHS "Summon Frost Moths" // Should this z-level be able to summon frost moths? Used so that they don't spawn too low underground.
